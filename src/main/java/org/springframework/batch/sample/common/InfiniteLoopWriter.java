...
/**
 * Simple module implementation that will always return true to indicate that processing should continue. This is useful
 * for testing graceful shutdown of jobs.
 * 
 * @author Lucas Ward
 * 
 */
