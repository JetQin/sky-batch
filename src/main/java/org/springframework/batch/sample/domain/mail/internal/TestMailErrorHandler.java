...
/**
 * This handler prints out failed messages with their exceptions. It also maintains a list of all failed messages it
 * receives for lookup later by an assertion.
 * 
 * @author Dan Garrette
 * @author Dave Syer
 * 
