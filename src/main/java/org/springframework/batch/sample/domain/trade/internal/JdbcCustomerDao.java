...
public class JdbcCustomerDao extends JdbcDaoSupport implements CustomerDao
{
	...
	public CustomerCredit getCustomerByName(String name)
	{
		...
		List<CustomerCredit> customers = getJdbcTemplate().query(GET_CUSTOMER_BY_NAME, new Object[]
		{ name },
	...
	public void insertCustomer(String name, BigDecimal credit)
	{
		...
		getJdbcTemplate().update(INSERT_CUSTOMER, new Object[]
		{ incrementer.nextIntValue(), name, credit });
	}

	@Override
	public void updateCustomer(String name, BigDecimal credit)
	{
		getJdbcTemplate().update(UPDATE_CUSTOMER, new Object[]
		{ credit, name });
	}
