...
/**
 * Composite {@link LineTokenizer} that delegates the tokenization of a line to one of two potential tokenizers. The
 * file format in this case uses one character, either F, A, U, or D to indicate whether or not the line is an a footer
 * record, or a customer add, update, or delete, and will delegate accordingly.
 * 
 * @author Lucas Ward
 * @since 2.0
 */
public class CompositeCustomerUpdateLineTokenizer extends StepExecutionListenerSupport implements LineTokenizer
{
	...
	/**
	 * Set the {@link LineTokenizer} that will be used to tokenize any lines that begin with A, U, or D, and are thus a
	 * customer operation.
	 * 
	...
	/**
	 * Set the {@link LineTokenizer} that will be used to tokenize any lines that being with F and is thus a footer
	 * record.
	 * 
