...
/**
 * A wrapper type for an item that is used by {@link AggregateItemReader} to identify the start and end of an aggregate
 * record.
 * 
...
public class AggregateItem<T>
{
	 ...
	 * @throws IllegalStateException if called on a record for which either {@link #isHeader()} or {@link #isFooter()}
	 * answers true.
	 */
	public T getItem()
	{
